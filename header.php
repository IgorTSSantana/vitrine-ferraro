...
<body>
    <header>
        <div id="area-logo">
            <img class="imagem-logo" style="width:560px;height:200px;" src="<?php echo get_template_directory_uri() . '/public/img/logo2.png' ?>">
        </div>
        ...
        <div id="area-menu">
            ...
            <?php if (!empty($product_categories)) : ?>
                <div class="btn-group menu-link">
                    ...
                    <button type="button" class="menu-link dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="dropdown-menu menu-link dropdown-link">
                        <?php foreach ($product_categories as $key => $category) : ?>
                            <?php if ($category->slug != 'sem-categoria') : ?>
                                <a class="dropdown-item categorias-produtos" href="<?= get_site_url() . '/produtos?categoria=' . $category->slug ?>">
                                    <?= $category->name ?>
                                </a>
                            <?php endif; ?>
                        <?php endforeach; ?>
