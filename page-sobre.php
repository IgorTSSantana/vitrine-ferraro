...
<div class="container container-top">
    ...
    <section class="row">
        ...
        <p class="fonte-texto">A Óptica Ferraro é uma pequena óptica fundada em 2014 pelo casal Leonardo e Elisabete com o objetivo
    ...
    <article class="col-lg-6 margem">
        ...
        <p class="fonte-texto">Ser uma óptica em destaque nacional e ter seus produtos reconhecidos pela sua excelente qualidade.</br>
        </p>
        <h3 class="margem-top">Valores</h3>
        <ul class="lista">
            <li class="fonte-texto">Honestidade</li>
            <li class="fonte-texto">Qualidade</li>
            <li class="fonte-texto">Comprometimento</li>
            <li class="fonte-texto">Respeito</li>
            <li class="fonte-texto">Lealdade</li>
            <li class="fonte-texto">Higiene</li>
        </ul>
